...
- explicit follow-up dates create bounded due/overdue reminders through the
  existing scheduler, alerts, notification preferences, email, and digest
  foundations, with duplicate suppression by due-state transition;
...
Phase 44 reuses it for bounded operational follow-up reminders. It is not a
task-management suite, arbitrary recurrence engine, calendar system,
SLA/escalation product, workforce planner, or AI scheduler.
...
24. bounded follow-up reminders for supported operational records;
25. then broader automation.
...
- follow-up due/overdue reminders for supported records, generated by the
  worker scheduler with target revalidation and duplicate suppression.
