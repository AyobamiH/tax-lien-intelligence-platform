...
- [KB README](kb/README.md)
- [Master Product KB](kb/master-product-kb.md)
- [Repo Reality KB](kb/repo-reality-kb.md)
- [Security Hardening KB](kb/security-hardening-kb.md)

The KB separates current implementation truth from future direction. Use it
before writing specs, prompts, or implementation plans.
