...
- an explicit follow-up becomes due or overdue.
...
- `follow_up_due` alerts for revalidated follow-ups that become due or
  overdue;
...
- recurring reminder engines or calendar sync;
...
Follow-up alerts are generated by the worker scheduler after the authoritative
follow-up record is revalidated; they do not expand record access or copy
follow-up note text.
...
- workspace-aware shared-record navigation for follow-up alerts;
